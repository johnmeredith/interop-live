        ...
        <div id="main" className="alt">
            <section id="one">
                <div className="inner">
                    ...
                    <p><span className="image right"><img src={ccfc} alt="Cardiff City Stadium" /></span>
